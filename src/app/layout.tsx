...
export const metadata: Metadata = {
  ...
  description:
    "Производство изделий из натурального камня: столешницы, подоконники, лестницы, камины. Собственное производство в Воскресенске. От замера до монтажа за 3 дня.",
  keywords: [
    "изделия из мрамора",
    "изделия из гранита",
    "столешницы из камня",
